            ...
            return (
              ...
              >
                ...
                <div className="space-y-2.5 max-w-3xl">
                  ...
                  {/* Supporting Analytics & Confidence */}
                  {(rec.confidence !== undefined || rec.supporting_analytics) && (
                    <div className="flex flex-wrap items-center gap-x-6 gap-y-2 bg-slate-950/60 p-2.5 rounded-xl border border-slate-900/60 text-xs w-fit">
                      {rec.confidence !== undefined && (
                        <div className="flex items-center gap-2">
                          ...
                          <div className="w-16 bg-slate-900 rounded-full h-1.5 overflow-hidden">
                            <div className="bg-indigo-500 h-1.5 rounded-full" style={{ width: `${rec.confidence * 100}%` }} />
                          </div>
                          <span className="font-mono font-bold text-indigo-400">{(rec.confidence * 100).toFixed(0)}%</span>
                        </div>
                      )}
                      {rec.supporting_analytics && (
                        <div className="flex items-center gap-1.5">
                          <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">Source:</span>
                          <span className="font-mono text-indigo-300 bg-indigo-500/5 px-2 py-0.5 rounded border border-indigo-500/10 text-[9px] uppercase tracking-wide">
                            {rec.supporting_analytics}
                          </span>
                        </div>
                      )}
